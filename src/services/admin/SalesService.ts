...
export const getSaleById = async (id: string): CustomResponsePromise<any> => {
  try {
    ...
    return {
      message: result[0] ? 'Sale retrieved successfully' : 'Sale not found',
      data: result[0] || null,
...
export const updateSale = async (id: string, data: Partial<SalesType>): CustomResponsePromise<SalesType> => {
  try {
    ...
    return {
      message: sale ? 'Sale updated successfully' : 'Sale not found',
      data: sale,
      code: sale ? 200 : 404,
    };
  } catch (error) {
...
export const deleteSale = async (id: string): CustomResponsePromise<null> => {
  try {
    ...
    return {
      message: sale ? 'Sale deleted successfully' : 'Sale not found',
      data: null,
      code: sale ? 200 : 404,
    };
  } catch (error) {
 ...
 */
export const getSaleUsage = async (id: string): CustomResponsePromise<any> => {
  try {
    ...
    return {
      ...
      data: {
        limit: sale.limit,
        variants: sale.variants.map((v: any) => ({ maxBuys: v.maxBuys, boughtCount: v.boughtCount })),
...
export const decrementSaleLimit = async (id: string, variantIndex?: number): CustomResponsePromise<SalesType> => {
  try {
    ...
    await sale.save();
    return {
      message: 'Sale decremented successfully',
      data: sale,
      code: 200,
    };
  } catch (error) {
...
export const checkSaleOnCheckout = async (saleId: string, variantIndex?: number): CustomResponsePromise<SalesType> => {
  try {
    ...
    return {
      message: 'Sale is valid for checkout',
      data: sale,
      code: 200,
    };
  } catch (error) {
